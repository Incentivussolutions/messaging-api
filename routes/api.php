...
Route::group(['middleware'=> ['auth.api']], function() {
    ...
    Route::post('common-data/index', [CommonDataController::class, 'index']);
    Route::post('common-data/get-list', [CommonDataController::class, 'getList']);
    Route::post('common-data/form-data', [CommonDataController::class, 'formData']);
    Route::post('common-data/store', [CommonDataController::class, 'store']);
    Route::post('common-data/delete', [CommonDataController::class, 'delete']);
